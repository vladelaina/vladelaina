...
const translations = {
    'zh': {
        ...
        'catimeDesc': '一款极致轻量的 Windows 倒计时工具，具有番茄工作法功能、透明界面和丰富自定义选项，只需几 MB 内存且几乎不占用 CPU 资源，便可在Windows 上优雅掌控时间。该项目在GitHub上获得了2.7k+的星标。',
    ...
    'en': {
        ...
        'catimeDesc': 'An ultra-lightweight Windows countdown tool featuring Pomodoro functionality, transparent interface, and rich customization options. With only a few MB of memory and virtually no CPU usage, elegantly control your time on Windows. This project has received 2.7k+ stars on GitHub.',
